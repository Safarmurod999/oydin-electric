...
const Bookmarks = () => {
    ...
    return (
        <>
            ...
            <div onClick={() => dispatch(setBookmarkOpen(true))} className="fixed right-0 md:right-[50px] bottom-[100px] z-20 bg-blue rounded-2xl p-[18px] flex items-center justify-center ">
