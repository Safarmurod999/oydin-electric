            ...
            <nav className='relative py-[15px] lg:py-[30px] bg-gray rounded-b-[24px] '>
                <Container style={'flex items-center justify-between'}>
                    ...
                    <div className={`flex grow-[0.5] flex-col xl:flex-row items-start 
                        ...
                        <div className="navbar-main w-full xl:w-auto">
                            <ul className="navbar-menu w-full xl:w-auto flex flex-col xl:flex-row items-start xl:items-center justify-center">
                                <li className="w-full navbar-item text-dark-gray font-bold whitespace-nowrap">
                                    <Dropdown title={'Katalog'} links={catalog} navigation={'catalog'} />
                                </li>
                                <li className="w-full navbar-item text-dark-gray font-bold whitespace-nowrap p-[16px]">
                                    <a aria-label='nav-link' href="https://oydin-electric.framer.website/b2b" className="navbar-link font-inter uppercase transition duration-300 hover:text-blue">B2B sotuv</a>
                                </li>
                                <li className="w-full navbar-item text-dark-gray font-bold whitespace-nowrap p-[16px]">
                                    <a aria-label='nav-link'  href="https://oydin-electric.framer.website/news" className="navbar-link font-inter uppercase transition duration-300 hover:text-blue">Yangiliklar</a>
                                </li>
                                <li className="w-full navbar-item text-dark-gray font-bold whitespace-nowrap">
                                    <Dropdown title={'Brendlar'} links={brands} navigation={'brand'} />
                                </li>
                                <li className="w-full navbar-item text-dark-gray font-bold whitespace-nowrap p-[16px]">
                                    <a aria-label='nav-link'  href="https://oydin-electric.framer.website/about-us" className="navbar-link font-inter uppercase transition duration-300 hover:text-blue">Kompaniya haqida</a>
                                </li>
                            </ul>
                        </div>
                        <div className="navbar-contact flex items-center gap-[15px] p-3 xl:p-0">
                            <a aria-label='nav-link'  href="tel:+998 71 184 11 81" className="navbar-link bg-blue py-[16px] px-[25px] rounded-2xl">
                            ...
                            <a aria-label='nav-link'  href="/" className="navbar-link bg-blue py-[16px] px-[25px] rounded-2xl">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button aria-label='nav-toggle' className='flex xl:hidden p-[10px] rounded-[13px] border-[1.5px] border-[#3A3A3B]' onClick={() => setOpenNavbar(!openNavbar)}>
                        {
