...
const Aside = ({ openAside, setOpenAside }) => {
    return (
        <aside className={`fixed top-[100px] md:top-[110px] left-0 w-full md:w-auto h-[91svh] xl:static p-6 xl:p-0 overflow-y-scroll
            drop-shadow-lg xl:drop-shadow-none rounded-lg transition duration-300 xl:translate-x-0
            bg-white z-20 ${openAside ? 'translate-x-0' : '-translate-x-[100%]'}`}>
