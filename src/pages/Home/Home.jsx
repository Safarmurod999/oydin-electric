          ...
          <ul className="flex flex-row flex-wrap gap-6">
            {
              brandArray.map(brand => (
                <li key={brand.id} className="relative group w-brand-width xs:w-[150px] sm:w-[170px] md:w-[220px] h-[72px] flex items-center justify-start gap-[15px] p-[12px] pe-[20px] cursor-pointer">
                  ...
                  <div className="text-[10px] text-[8px] sm:text-sm font-bold text-black z-10 uppercase group-hover:text-white">{brand.title}</div>
