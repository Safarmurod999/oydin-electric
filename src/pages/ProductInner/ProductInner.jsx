            ...
            <section className='pb-[40px] md:pb-[80px] lg:pb-[120px] xl:pb-[160px] 2xl:pb-[200px] 3xl:pb-[240px]'>
                <Container>
                    ...
                    <div className="grow flex flex-wrap items-stretch justify-center inner:justify-betweeen gap-[10px] lg:gap-[30px] mb-12 mt-[40px] md:mt-[60px] xl:mt-[80px] 2xl:mt-[100px] 3xl:mt-[120px]">
                        {
                            products.map(el => {
                                return <div key={el.id} className="flex flex-col relative w-card-xl lg:w-card-2xl 3xl:w-card-3xl">
                                    ...
                                    <div className="flex flex-col items-center justify-between px-[12px] mini:px-[15px] sm:px-[30px] pt-[50px] pb-[15px] mini:pb-[25px] slider:pb-[40px] -mt-[45px] 3xl:-mt-[40px] 3xl:-mt-12 border-[3px] border-gray rounded-xl slider:rounded-3xl h-full">
                                        ...
                                        <div className="w-full flex items-center justify-between gap-[5px] slider:gap-[12px] mt-auto">
                                            <div className="group flex items-stretch justify-between grow">
                                                ...
                                                <button aria-label='more-btn' onClick={() => navigate(`/catalog/${el.id}`)} className="relative flex items-center justify-center gap-[10px] grow py-[6px] slider:py-[15px] -mx-[1px] bg-blue group-hover:bg-yellow  h-[21px] slider:h-[54px]">
