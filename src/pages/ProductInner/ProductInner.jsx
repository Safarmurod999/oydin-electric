        ...
        <section className='pb-[40px] md:pb-[80px] lg:pb-[120px] xl:pb-[160px] 2xl:pb-[200px] 3xl:pb-[240px]'>
            <Container>
                <ul className='flex flex-wrap items-center justify-start gap-[5px] mb-[40px]'>
                    ...
                    <li className="uppercase font-inter text-dark-gray transition duration-300 hover:text-blue cursor-pointer text-sm">
                        <a href={`/catalog/${id}`} className='whitespace-nowrap'>Proyektor MGL</a>
                    </li>
                </ul>
                {/* PAGE TOP */}
                <div className="w-[270px] flex items-stretch justify-center h-[64px] mb-[64px]">
                    ...
                    <a href="/catalog" className='flex items-center justify-center gap-[10px] border-y-2 border-y-light-gray -mx-[1px] w-[234px]'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 3xl:grid-cols-4 gap-8 grow mb-12 mt-[120px]">
                    {
                                ...
                                return <div key={el.id} className="flex flex-col relative w-full">
                                    ...
                                    <div className="px-[30px] pt-[70px] 3xl:pt-[50px]  pb-[40px] -mt-20 3xl:-mt-12 border-[3px] border-gray rounded-3xl">
                                        <div className="flex flex-col mb-[20px] xl:mb-[40px]">
                                            <div className="w-full flex items-center justify-between py-[15px]">
                                                <div className="text-[18px] sm:text-[14px] font-bold font-dacia text-blue">{el.name.split(" ")[0]}</div>
                                                <div className="text-[18px] sm:text-[14px] font-bold font-dacia text-dark-gray text-end uppercase">{el.name.split(" ")[1]}</div>
                                            </div>
                                            ...
                                            <div className="w-full flex items-center justify-between py-[15px]">
                                                <div className="text-[16px] font-inter sm:text-[14px] font-bold text-black">Kommutatsiya quvvati</div>
                                                <div className="text-[16px] font-inter sm:text-[14px] font-bold text-dark-gray text-end uppercase">{el.power} WATT</div>
                                            </div>
                                            <svg className="w-full" width="336" height="1" viewBox="0 0 336 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <line opacity="0.3" y1="0.5" x2="336" y2="0.5" stroke="#66708D" strokeDasharray="8 8" />
                                            </svg>
                                            <div className="w-full flex items-center justify-between py-[15px]">
                                                <div className="text-[16px] font-inter sm:text-[14px] font-bold text-black">Qutblar soni</div>
                                                <div className="text-[16px] font-inter sm:text-[14px] font-bold text-dark-gray text-end">{el.polarity} ta</div>
                                            </div>
                                            <svg className="w-full" width="336" height="1" viewBox="0 0 336 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <line opacity="0.3" y1="0.5" x2="336" y2="0.5" stroke="#66708D" strokeDasharray="8 8" />
                                            </svg>
                                            <div className="w-full flex items-center justify-between py-[15px]">
                                                <div className="text-[16px] font-inter sm:text-[14px] font-bold text-black">Operatsion xarakteristikasi</div>
                                                <div className="text-[16px] font-inter sm:text-[14px] font-bold text-dark-gray text-end uppercase">{el.characteristic}</div>
                                            </div>
                                        </div>
                ...
                <div className="w-[300px] sm:w-[390px] flex items-stretch justify-center h-[64px] mb-[64px] mx-auto">
                    ...
                    <a href="/catalog" className='flex items-center justify-center gap-[10px] border-y-2 border-y-light-gray -mx-[1px] grow'>
                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
